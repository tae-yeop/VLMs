...
def print_trainable_parameters(self) -> None:
    ...
    """
    # Check embed_tokens
    embed_layer = getattr(self, "embed_tokens", None)
    if embed_layer is None:                       # Qwen2.5-VL 등
        embed_layer = self.get_input_embeddings() # 공식 API
    is_embed_trainable = any(p.requires_grad for p in embed_layer.parameters())
